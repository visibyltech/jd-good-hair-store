...
const CATEGORY_COLORS = {
  'Bundles':  { bg: 'rgba(59,130,246,0.12)', text: '#3b82f6', border: 'rgba(59,130,246,0.35)' },
  'Wigs':     { bg: 'rgba(139,92,246,0.12)', text: '#7c3aed', border: 'rgba(139,92,246,0.35)' },
  'Closures': { bg: 'rgba(236,72,153,0.12)', text: '#db2777', border: 'rgba(236,72,153,0.35)' },
  'Frontals': { bg: 'rgba(245,158,11,0.12)', text: '#d97706', border: 'rgba(245,158,11,0.35)' }
};
...
export default function ProductForm() {
  ...
  const catColor = CATEGORY_COLORS[formData.category] || CATEGORY_COLORS['Bundles'];
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        {/* Header banner */}
        <div style={{
          background: 'linear-gradient(135deg,var(--primary) 0%,#be123c 60%,#881337 100%)',
          padding: '28px 36px',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <FieldGroup label="Product Name" icon={<Tag size={14} />} accent="#7c3aed">
              <input
                ...
                placeholder="e.g. Bone Straight 18 inch"
                style={inputStyle}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
              ...
              <FieldGroup label='Length' icon={<Ruler size={14} />} accent="#059669">
                <input
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16 }}>
              <FieldGroup label="Brand / Type" icon={<Tag size={14} />} accent="#10b981">
                <input
                  type="text" name="brand" value={formData.brand || ''}
                  onChange={handleChange} placeholder="e.g. Brazilian, Peruvian..."
                  style={inputStyle}
              ...
              <FieldGroup label="Product Description / Features" icon={<Sparkles size={14} />} accent="#8b5cf6">
                <textarea
                  ...
                  onChange={handleChange} placeholder="Enter features separated by lines"
            ...
            <button
              ...
              style={{
                ...
                background: loading
                  ? '#9ca3af'
                  : 'linear-gradient(135deg,var(--primary) 0%,#be123c 60%,#881337 100%)',
              ...
              onMouseEnter={e => { if (!loading) { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 12px 32px rgba(225,29,72,0.45)'; } }}
              onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(225,29,72,0.35)'; }}
            >
              {loading ? (
